...
{
    public class WriterValidatator : AbstractValidator<RegisterDto>
    {
        public WriterValidatator()
        {
            ...
            RuleFor(x => x.WriterPassword).Equal(x => x.ConfirmPassword).WithMessage("Şifreleriniz birbiriyle eşleşmiyor");
